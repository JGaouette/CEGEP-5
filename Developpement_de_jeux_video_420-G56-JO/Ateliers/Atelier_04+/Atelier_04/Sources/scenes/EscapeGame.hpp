...
public:
    ...
    void load() override {
        ...
        timerSize = ResourcesManager::getResource<TTFont>(DEFAULT_FONT)->getSize("Temps restant: 0:00");

        // TimerLabel
        timerLabel = new TimerLabel({(double)(size.x / 2) - (double)(timerSize.x / 2), 0}, 60.0, "Temps restant: ", DEFAULT_FONT, COLOR_BLACK);
        timerLabel->setAction(onTimeOut);
    ...
    void notification() {
        switch (Event::getCustomCode()) {
            ...
            case TIME_OUT:
                endMessage = new Label({0, 0}, "TEMPS ÉCOULÉ", "font-big", COLOR_WHITE);
            ...
            /// TODO: Donner assez de points pour passer le quart.
            case WINNER:
    ...
    static void onTimeOut() {
        Event::pushCustomEvent(TIME_OUT);
    }
